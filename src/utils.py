...
def inference(model, url):
    ...
    plt.imshow(
        CM[unique_labels].astype(np.uint8), interpolation='nearest') # adobted from tensorflow - model zoo
    ax.yaxis.tick_right()
